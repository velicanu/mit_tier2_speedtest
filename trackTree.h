...
// Wed May 17 16:34:30 2017 by ROOT version 6.02/13
// from TTree trackTree/v1
// found on file: /mnt/hadoop/cms/store/user/velicanu/Merged/Pythia8_Ze10e10_m60120_pthat0_TuneCUETP8M1_5020GeV_GEN_SIM_PU_20160110_FOREST_v24/0.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         trkPt[11236];   //[nTrk]
   Float_t         trkPtError[11236];   //[nTrk]
   UChar_t         trkNHit[11236];   //[nTrk]
   UChar_t         trkNlayer[11236];   //[nTrk]
   Float_t         trkEta[11236];   //[nTrk]
   Float_t         trkPhi[11236];   //[nTrk]
   Int_t           trkCharge[11236];   //[nTrk]
   UChar_t         trkNVtx[11236];   //[nTrk]
   Int_t           nTrkTimesnVtx;
   Bool_t          trkAssocVtx[11236];   //[nTrkTimesnVtx]
   Float_t         trkDxyOverDxyError[11236];   //[nTrkTimesnVtx]
   Float_t         trkDzOverDzError[11236];   //[nTrkTimesnVtx]
   Bool_t          highPurity[11236];   //[nTrk]
   Bool_t          tight[11236];   //[nTrk]
   Bool_t          loose[11236];   //[nTrk]
   Float_t         trkChi2[11236];   //[nTrk]
   UChar_t         trkNdof[11236];   //[nTrk]
   Float_t         trkDxy1[11236];   //[nTrk]
   Float_t         trkDxyError1[11236];   //[nTrk]
   Float_t         trkDz1[11236];   //[nTrk]
   Float_t         trkDzError1[11236];   //[nTrk]
   Bool_t          trkFake[11236];   //[nTrk]
   UChar_t         trkAlgo[11236];   //[nTrk]
   UChar_t         trkOriginalAlgo[11236];   //[nTrk]
   Float_t         trkMVA[11236];   //[nTrk]
   Bool_t          trkMVATight[11236];   //[nTrk]
   Int_t           pfType[11236];   //[nTrk]
   Float_t         pfCandPt[11236];   //[nTrk]
   Float_t         pfEcal[11236];   //[nTrk]
   Float_t         pfHcal[11236];   //[nTrk]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
     TFile *f = TFile::Open("/mnt/hadoop/cms/store/user/velicanu/Merged/Pythia8_Ze10e10_m60120_pthat0_TuneCUETP8M1_5020GeV_GEN_SIM_PU_20160110_FOREST_v24/0.root");
     if(!f) f = TFile::Open("/mnt/T2_US_MIT/hadoop/cms/store/user/velicanu/Merged/Pythia8_Ze10e10_m60120_pthat0_TuneCUETP8M1_5020GeV_GEN_SIM_PU_20160110_FOREST_v24/0.root");
